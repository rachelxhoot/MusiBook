package com.example.myapplication.costumview;
...
public class DiscView extends RelativeLayout {
    ...
    private void initNeedle() {
        ...
        Bitmap originBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_needle);
    ...
    private Drawable getDiscDrawable(Bitmap bitmap) {
        ...
        Bitmap bitmapMusicPic = getMusicPicBitmap(musicPicSize,bitmap);
    ...
    public void setMusicDataList(List<MusicData> musicDataList) {
        ...
        for (MusicData musicData : mMusicDatas) {
            ...
            //替换成bitMap
            disc.setImageDrawable(getDiscDrawable(musicData.getBitmap()));
